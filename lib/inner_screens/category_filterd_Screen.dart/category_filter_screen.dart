...
import 'package:pharnacy_trust/inner_screens/category_filterd_Screen.dart/empty_screen_for_product.dart';
...
class CategoryFilterScreen extends StatefulWidget {
  ...
  static const routeName = '/CategoryFilterScreen';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: categoryList.isEmpty
          ? const Center(child: EmptyNotificationsScreen())
          : SafeArea(
              child: Padding(
